            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form
                            action="{{ url(route('clients.orders.update', ['order' => $order->id, 'client' => $client->id])) }}"
                            method="post">
